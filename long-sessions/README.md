...
into sequential sessions, suppress verbose logs, add context
management rules to CLAUDE.md, and checkpoint with STATUS.md so
a new session can pick up seamlessly.
